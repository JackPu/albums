...
var _base = require('./base.js');var _base2 = _interopRequireDefault(_base);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _class = function (_Base) {(0, _inherits3.default)(_class, _Base);function _class() {(0, _classCallCheck3.default)(this, _class);return (0, _possibleConstructorReturn3.default)(this, _Base.apply(this, arguments));}
  ...
  _class.prototype.removecatAction = function () {var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5() {var catid, isSuccess;return _regenerator2.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
              ...
              this.success(isSuccess));case 5:case 'end':return _context5.stop();}}}, _callee5, this);}));function removecatAction() {return _ref5.apply(this, arguments);}return removecatAction;}();_class.prototype.


  logoutAction = function () {var _ref6 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee6() {var id, isSuccss;return _regenerator2.default.wrap(function _callee6$(_context6) {while (1) {switch (_context6.prev = _context6.next) {case 0:
              id = this.post('id');_context6.next = 3;return (
                this.model('user').removeToken(id));case 3:isSuccss = _context6.sent;if (!
              isSuccess) {_context6.next = 8;break;}return _context6.abrupt('return',
              this.success(''));case 8:return _context6.abrupt('return',

              this.success(''));case 9:case 'end':return _context6.stop();}}}, _callee6, this);}));function logoutAction() {return _ref6.apply(this, arguments);}return logoutAction;}();return _class;}(_base2.default);exports.default = _class;